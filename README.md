...
详细的 v0.0.5 格式验收、v0.0.6 实现记录、依赖审计和签名流程见 [格式验收](docs/v0.0.5-format-acceptance.md)、[v0.0.6 实现记录](docs/v0.0.6-implementation.md) 和 [依赖审计](docs/dependency-audit-v0.0.5.md)；
